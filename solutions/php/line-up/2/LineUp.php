...
function format(string $name, int $number): string
{
    ...
    $lastNumber = substr($numberStr,-1);
    $lastTwoNumber = substr($numberStr,-2);
    $ordinal = $number.match(true){
        ($lastNumber === '1' && $lastTwoNumber !== '11') => 'st',
        ($lastNumber === '2' && $lastTwoNumber !== '12') => 'nd',
        ($lastNumber === '3' && $lastTwoNumber !== '13') => 'rd',
        default => 'th',
    };
